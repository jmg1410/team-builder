...
export default function App() {
  ...
  const onChange = evt => {
   const {id, value} = evt.target // ✨ This is the change handler for your text inputs and your textarea.
    setValues({...values,[id]:value})// You can check `evt.target.id` to know which input changed
